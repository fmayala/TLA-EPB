...
DROP TABLE IF EXISTS "XfmrTimeInterval" CASCADE;
DROP TABLE IF EXISTS "XfmrMeasure" CASCADE;
DROP TABLE IF EXISTS "XfmrMaxMeasures" CASCADE;
DROP TABLE IF EXISTS "XfmrDriverProfile" CASCADE;
DROP TABLE IF EXISTS "XfmrDimension" CASCADE;
