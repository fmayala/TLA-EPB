		...
		>
			...
			<div class="mb-4">
				...
				<p class="text-sm text-muted-foreground mt-2">
					EV kWh Expenditure is the amount of kilowatts an hour used by the vehicle per mile. See <a target="_blank" href="https://ecocostsavings.com/electric-car-kwh-per-mile-list/">here</a> for common values.
				</p>
